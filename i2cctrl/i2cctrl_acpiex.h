...
#include "i2cctrl_ext.h"     /* I2CCTRL_FDO */
...
/* ---------------------------------------------------------------------------
   Per-handle context for ACPIEx-style clients
   --------------------------------------------------------------------------- */
...
/* ---------------------------------------------------------------------------
   ...
   --------------------------------------------------------------------------- */
VOID
I2cCtrl_AcpiexInit(PI2CCTRL_FDO Dx);

NTSTATUS
I2cCtrl_AcpiexCreate(PDEVICE_OBJECT Fdo, PIRP Irp, PIO_STACK_LOCATION Isl);

NTSTATUS
I2cCtrl_AcpiexClose(PDEVICE_OBJECT Fdo, PIRP Irp, PIO_STACK_LOCATION Isl);

NTSTATUS
I2cCtrl_AcpiexDeviceControl(PDEVICE_OBJECT Fdo, PIRP Irp, PIO_STACK_LOCATION Isl);
...
NTSTATUS
I2cCtrl_AcpiexTransfer(PI2CCTRL_FDO Dx,
                       PI2CCTRL_ACPIEX_HANDLE H,
...
NTSTATUS
I2cCtrl_AcpiexSequence(PI2CCTRL_FDO Dx,
                       PI2CCTRL_ACPIEX_HANDLE H,
...
NTSTATUS
I2cCtrl_AcpiexProbe(PI2CCTRL_FDO Dx,
                    PI2CCTRL_ACPIEX_HANDLE H,
                    I2CCTRL_PROBE In,
