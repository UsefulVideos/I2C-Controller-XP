...
/* Whiskey Lake / CNL-LP LPSS private registers (BAR2 + offsets) */
#define WHL_LPSS_CLK_CTL     0x200   /* functional/APB/force clock enable */
...
#define WHL_PW_STS_OFFSET       0x5C4   /* Status PW1/PW2 */
#define WHL_PW_FORCE_ON_OFFSET  0x5C8   /* Force-on mask */

#define WHL_PW1_BIT             (1u << 1)
