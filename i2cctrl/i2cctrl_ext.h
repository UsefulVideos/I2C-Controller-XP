...
#include "..\gpioctrl\gpioctrl_public.h"
...
NTSTATUS (*DeleteChildrenFn)(
    PDEVICE_OBJECT Fdo,
    PI2CCTRL_FDO devctx,
    PULONG ChildCount
);

NTSTATUS (*EnumerateChildrenFn)(
    PDEVICE_OBJECT Fdo,
    PI2CCTRL_FDO devctx,
    PULONG ChildCount
);

NTSTATUS (*ReenumerateChildrenFn)(
    PDEVICE_OBJECT Fdo,
    PI2CCTRL_FDO devctx,
    PULONG ChildCount
);
    ...
    BOOLEAN          HavePwrm;
    //
    // Policy override for PMC PWRMBASE (low 32 bits only)
    // Loaded by I2cCtrl_LoadRegistryPolicy()
    //
...
/* ACPI child enumeration, deenumeration and reenumeration */
...
typedef struct _I2CCTRL_PDO {
    ...
    UNICODE_STRING     InstanceId;
	UNICODE_STRING	   HardwareId2;
	UNICODE_STRING 	   HardwareId3;
	UNICODE_STRING 	   HardwareId4;
...
NTSTATUS I2cCtrl_Create(PDEVICE_OBJECT DeviceObject, PIRP Irp);
NTSTATUS I2cCtrl_Close(PDEVICE_OBJECT DeviceObject, PIRP Irp);
NTSTATUS I2cCtrl_Cleanup(PDEVICE_OBJECT DeviceObject, PIRP Irp);
...
/* ============================================================================
   Power helpers
   ============================================================================ */
NTSTATUS I2cCtrl_SetControllerPowerD0(PI2CCTRL_FDO devctx);
VOID     I2cCtrl_SetControllerPowerD1(PI2CCTRL_FDO devctx);
VOID     I2cCtrl_SetControllerPowerD2(PI2CCTRL_FDO devctx);
VOID     I2cCtrl_SetControllerPowerD3(PI2CCTRL_FDO devctx);
...
//
// Nonpaged ring buffer for ISR/DPC logging
//
#define I2CCTRL_ISRLOG_SIZE  8192

extern CHAR        I2cCtrl_IsrLogBuffer[I2CCTRL_ISRLOG_SIZE];
extern ULONG       I2cCtrl_IsrLogIndex;
extern KSPIN_LOCK  I2cCtrl_IsrLogLock;
