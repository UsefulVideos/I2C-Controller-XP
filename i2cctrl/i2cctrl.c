...
// Unknown signatures are forwarded down the stack.
    ...
    )
{
    ...
    //
    // If extension is NULL, this is not our device.
    // Forward IRP down instead of failing.
    //
    if (hdr == NULL) {
    ...
    default:
        //
        // IMPORTANT:
        // Unknown signature means this DO does NOT belong to our bus driver.
        // We MUST NOT fail the IRP — we must pass it down.
        //
        I2cCtrl_Log("PnP: Device %p has UNKNOWN signature 0x%08lX -> forwarding\n",
