    ...
    )
{
    ...
    /*
     * XP RULE:
     * The ACPI PDO for a PCI device is simply the PhysicalDeviceObject
     * passed to AddDevice. That PDO belongs to ACPI.SYS.
     *
     * No stack walking, no file objects, no name lookups.
     */
    fdoExt->AcpiDeviceObject = fdoExt->PhysicalDevice;
 ...
 * - PASSIVE_LEVEL only
 * - No file object to release (XP ACPI uses PDO only)
    ...
    )
{
    ...
    /*
     * XP ACPI binding uses only the PDO (PhysicalDeviceObject).
     * There is no FILE_OBJECT to dereference.
     */
    fdoExt->AcpiDeviceObject = NULL;
    fdoExt->AcpiFileObject   = NULL;
    fdoExt->AcpiHandle       = NULL;
