...
)
{
    ...
    /* Instance ID */
    RtlInitUnicodeString(&pdoExt->InstanceId, L"0");

    /* ------------------------------------------------------------
       MULTI_SZ = "I2CCTRL\\TOUCHPAD\0\0"
       ------------------------------------------------------------ */
    {
        ...
        if (buf != NULL) {
            ...
            pdoExt->HardwareIdsMultiSz = NULL;
            I2cCtrl_Log("CreateTouchpadPdo: FAILED to allocate MULTI_SZ\n");
        }
    }

    /* No CompatibleIdsMultiSz for now */
