...
// Unknown or invalid extensions are safely forwarded.
    ...
    )
{
    ...
    //
    // Defensive: if extension is NULL or unreadable, forward IRP.
    //
    if (hdr == NULL) {
        I2cCtrl_Log("PnP: Device %p has NULL extension -> forwarding\n",
                    DeviceObject);
    ...
    //
    // Validate signature before dereferencing further.
    //
    ...
    default:
        //
        // Unknown signature: do NOT touch hdr fields further.
        // Forward IRP down instead of failing to avoid stack corruption.
        //
        I2cCtrl_Log("PnP: Device %p has UNKNOWN or invalid signature -> forwarding\n",
                    DeviceObject);
