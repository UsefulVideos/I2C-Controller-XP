...
const I2CCTRL_DEVICE_ID g_I2cControllers[] = {
    /* ACPI-based controllers */
    { L"ACPI\\INT3446", 0x00, 0x04, 0x08, 0x0C, QUIRK_ACPI20, BSOD_NONE },
    { L"ACPI\\INT3447", 0x00, 0x04, 0x08, 0x0C, QUIRK_ACPI20, BSOD_FORCE_PIO },
    { L"ACPI\\AMD0010", 0x00, 0x04, 0x08, 0x0C, QUIRK_ACPI20, BSOD_NONE },
    { L"ACPI\\AMDI0010",0x00, 0x04, 0x08, 0x0C, QUIRK_ACPI20, BSOD_NONE },

    /* PCI-based controllers with quirks */
    { L"PCI\\VEN_8086&DEV_9DC5", 0x00, 0x04, 0x08, 0x0C,
      QUIRK_NEEDS_RESET_WORKAROUND, BSOD_EXTRA_RESET },

    { L"PCI\\VEN_8086&DEV_9DE8", 0x10, 0x14, 0x18, 0x1C,
      QUIRK_BROKEN_CLOCK_GATE, BSOD_MASK_INTERRUPTS },

    { L"PCI\\VEN_8086&DEV_9DE9", 0x20, 0x24, 0x28, 0x2C,
      QUIRK_NO_DMA_SUPPORT, BSOD_FORCE_PIO },

    { L"PCI\\VEN_8086&DEV_9DEA", 0x00, 0x04, 0x08, 0x0C,
      QUIRK_SLOW_CLOCK, BSOD_NONE },

    { L"PCI\\VEN_8086&DEV_9DEB", 0x00, 0x04, 0x08, 0x0C,
      QUIRK_NO_D1D2, BSOD_NONE },

    /* Legacy PCI controllers requiring ACPI 1.0b fallback */
    { L"PCI\\VEN_8086&DEV_A160", 0x00, 0x04, 0x08, 0x0C,
      QUIRK_ACPI10, BSOD_DELAY_INIT },
    { L"PCI\\VEN_8086&DEV_A161", 0x00, 0x04, 0x08, 0x0C,
      QUIRK_ACPI10, BSOD_DELAY_INIT },
    { L"PCI\\VEN_8086&DEV_A162", 0x00, 0x04, 0x08, 0x0C,
      QUIRK_ACPI10, BSOD_DELAY_INIT },
    { L"PCI\\VEN_8086&DEV_A163", 0x00, 0x04, 0x08, 0x0C,
      QUIRK_ACPI10, BSOD_DELAY_INIT },

    /* Other Intel PCI controllers (no quirks) */
    { L"PCI\\VEN_8086&DEV_A2E0", 0x00, 0x04, 0x08, 0x0C, QUIRK_NONE, BSOD_NONE },
    { L"PCI\\VEN_8086&DEV_A2E1", 0x00, 0x04, 0x08, 0x0C, QUIRK_NONE, BSOD_NONE },
    { L"PCI\\VEN_8086&DEV_A2E2", 0x00, 0x04, 0x08, 0x0C, QUIRK_NONE, BSOD_NONE },
    { L"PCI\\VEN_8086&DEV_A2E3", 0x00, 0x04, 0x08, 0x0C, QUIRK_NONE, BSOD_NONE },

    { L"PCI\\VEN_8086&DEV_31AC", 0x00, 0x04, 0x08, 0x0C, QUIRK_NONE, BSOD_NONE },
    { L"PCI\\VEN_8086&DEV_31AE", 0x00, 0x04, 0x08, 0x0C, QUIRK_NONE, BSOD_NONE },
    { L"PCI\\VEN_8086&DEV_31B0", 0x00, 0x04, 0x08, 0x0C, QUIRK_NONE, BSOD_NONE },
    { L"PCI\\VEN_8086&DEV_31B2", 0x00, 0x04, 0x08, 0x0C, QUIRK_NONE, BSOD_NONE },
    { L"PCI\\VEN_8086&DEV_31B4", 0x00, 0x04, 0x08, 0x0C, QUIRK_NONE, BSOD_NONE },
    { L"PCI\\VEN_8086&DEV_31B6", 0x00, 0x04, 0x08, 0x0C, QUIRK_NONE, BSOD_NONE },
    { L"PCI\\VEN_8086&DEV_31B8", 0x00, 0x04, 0x08, 0x0C, QUIRK_NONE, BSOD_NONE },
    { L"PCI\\VEN_8086&DEV_31BA", 0x00, 0x04, 0x08, 0x0C, QUIRK_NONE, BSOD_NONE },

    { L"PCI\\VEN_8086&DEV_A368", 0x00, 0x04, 0x08, 0x0C, QUIRK_NONE, BSOD_NONE },
    { L"PCI\\VEN_8086&DEV_A369", 0x00, 0x04, 0x08, 0x0C, QUIRK_NONE, BSOD_NONE },
    { L"PCI\\VEN_8086&DEV_A36A", 0x00, 0x04, 0x08, 0x0C, QUIRK_NONE, BSOD_NONE },
    { L"PCI\\VEN_8086&DEV_A36B", 0x00, 0x04, 0x08, 0x0C, QUIRK_NONE, BSOD_NONE },

    { L"PCI\\VEN_8086&DEV_02E8", 0x00, 0x04, 0x08, 0x0C, QUIRK_NONE, BSOD_NONE },
    { L"PCI\\VEN_8086&DEV_02E9", 0x00, 0x04, 0x08, 0x0C, QUIRK_NONE, BSOD_NONE },
    { L"PCI\\VEN_8086&DEV_02EA", 0x00, 0x04, 0x08, 0x0C, QUIRK_NONE, BSOD_NONE },
    { L"PCI\\VEN_8086&DEV_02EB", 0x00, 0x04, 0x08, 0x0C, QUIRK_NONE, BSOD_NONE },
    { L"PCI\\VEN_8086&DEV_02C5", 0x00, 0x04, 0x08, 0x0C, QUIRK_NONE, BSOD_NONE },
    { L"PCI\\VEN_8086&DEV_02C6", 0x00, 0x04, 0x08, 0x0C, QUIRK_NONE, BSOD_NONE },

    { L"PCI\\VEN_8086&DEV_06E8", 0x00, 0x04, 0x08, 0x0C, QUIRK_NONE, BSOD_NONE },
    { L"PCI\\VEN_8086&DEV_06E9", 0x00, 0x04, 0x08, 0x0C, QUIRK_NONE, BSOD_NONE },
    { L"PCI\\VEN_8086&DEV_06EA", 0x00, 0x04, 0x08, 0x0C, QUIRK_NONE, BSOD_NONE },
    { L"PCI\\VEN_8086&DEV_06EB", 0x00, 0x04, 0x08, 0x0C, QUIRK_NONE, BSOD_NONE }
};
...
/* -----------------------------------------------------------------------
 * I2cCtrl_StartDevice - HAL-generic, XP/2003 BSOD-safe, C89-compliant
 * Uses the unified backend + universal HID-over-I2C child creation.
 * ----------------------------------------------------------------------- */
NTSTATUS
I2cCtrl_StartDevice(
    ...
    )
{
    ...
    if (fdoExt == NULL || Irp == NULL) {
        TraceEvents(TRACE_LEVEL_ERROR, TRACE_FLAG_INIT,
                    "StartDevice: invalid parameters (fdoExt=%p, Irp=%p)", fdoExt, Irp);
        return STATUS_INVALID_PARAMETER;
    }
    ...
    TraceEvents(TRACE_LEVEL_INFORMATION, TRACE_FLAG_INIT,
                "StartDevice (Ctrl%lu)", fdoExt->ControllerId);

    if (transList == NULL || transList->Count == 0U) {
        TraceEvents(TRACE_LEVEL_ERROR, TRACE_FLAG_INIT,
                    "StartDevice: no translated resources");
        return STATUS_INSUFFICIENT_RESOURCES;
    }

    /* Parse translated resources for MMIO + IRQ */
    ...
    if (!haveMem) {
        TraceEvents(TRACE_LEVEL_ERROR, TRACE_FLAG_INIT,
                    "StartDevice: no MMIO resource");
        return STATUS_INSUFFICIENT_RESOURCES;
    }

    if (mmioLength < 0x00A8U) {
        TraceEvents(TRACE_LEVEL_ERROR, TRACE_FLAG_INIT,
                    "StartDevice: MMIO length too small (%lu)", mmioLength);
    ...
    if (fdoExt->Mmio == NULL) {
        TraceEvents(TRACE_LEVEL_ERROR, TRACE_FLAG_INIT,
                    "StartDevice: MmMapIoSpace failed (Phys=%I64x Len=%lu)",
                    (unsigned __int64)mmioPhys.QuadPart, mmioLength);
        return STATUS_INSUFFICIENT_RESOURCES;
    }
    ...
    /* Install backend (register map + ops) */
    ...
    if (!NT_SUCCESS(status)) {
        TraceEvents(TRACE_LEVEL_ERROR, TRACE_FLAG_INIT,
                    "StartDevice: disable did not latch");
    ...
    /* Connect interrupt (11-arg IoConnectInterrupt) if available */
    if (haveInt && fdoExt->InterruptObject == NULL) {
        ...
        if (!NT_SUCCESS(status)) {
            TraceEvents(TRACE_LEVEL_WARNING, TRACE_FLAG_INIT,
                        "StartDevice: IoConnectInterrupt failed (0x%08lx), "
                        "continuing without IRQ (polling mode)", status);
    ...
    if (!NT_SUCCESS(status)) {
        TraceEvents(TRACE_LEVEL_ERROR, TRACE_FLAG_INIT,
                    "StartDevice: enable did not latch");
        fdoExt->HardwareFailure = TRUE;
    ...
    /* Optional: probe for touchpad presence */
    {
        ...
        if (!NT_SUCCESS(status)) {
            TraceEvents(TRACE_LEVEL_WARNING, TRACE_FLAG_INIT,
                        "StartDevice: touchpad detection failed (0x%08lx)", status);
            fdoExt->TouchpadPresent = FALSE;
        } else {
            fdoExt->TouchpadPresent = detectResult.Present ? TRUE : FALSE;
            TraceEvents(TRACE_LEVEL_INFORMATION, TRACE_FLAG_INIT,
                        "StartDevice: touchpad present=%lu",
                        (ULONG)(detectResult.Present ? 1U : 0U));
        }
    }

    /* --------------------------------------------------------------------
     * Create universal HID-over-I2C child PDO (ACPI\PNP0C50)
     * XP + ACPI 2.0+ cannot enumerate modern I²C ACPI children (ELAN1200),
     * so we synthesize a child PDO whenever none were discovered.
     * -------------------------------------------------------------------- */
    if (IsListEmpty(&fdoExt->ChildList)) {
        ...
        /* Universal HID-over-I2C identifier */
        RtlStringCchCopyW(hidBuf, RTL_NUMBER_OF(hidBuf), L"ACPI\\PNP0C50");

        /* Static UID (XP ignores it for I²C children) */
        ...
        if (!NT_SUCCESS(status)) {
            ...
            TraceEvents(TRACE_LEVEL_WARNING, TRACE_FLAG_INIT,
                        "StartDevice: failed to create universal PNP0C50 PDO "
                        "(0x%08lx) - continuing without child PDO", status);

            /* Do NOT fail StartDevice */
            status = STATUS_SUCCESS;

        } else {

            /* Notify PnP that a new child PDO exists */
            IoInvalidateDeviceRelations(fdoExt->PhysicalDevice, BusRelations);
        }
    }

    TraceEvents(TRACE_LEVEL_INFORMATION, TRACE_FLAG_INIT,
                "StartDevice complete (Ctrl%lu)", fdoExt->ControllerId);
...
/* -----------------------------------------------------------------------
 * I2cCtrl_StopDevice - HAL-generic, XP/2003 teardown
 * Idempotent, restart-safe, C89-compliant.
 * ----------------------------------------------------------------------- */
NTSTATUS
I2cCtrl_StopDevice(
    IN PI2CCTRL_FDO fdoExt
    )
{
    ...
    TraceEvents(TRACE_LEVEL_INFORMATION, TRACE_FLAG_INIT,
                "StopDevice begin (Ctrl%lu)", fdoExt->ControllerId);
    ...
    if (fdoExt->Ops != NULL && fdoExt->Ops->Enable != NULL) {
        ...
        if (!NT_SUCCESS(status)) {
            TraceEvents(TRACE_LEVEL_WARNING, TRACE_FLAG_INIT,
                        "StopDevice: disable did not latch (0x%08lx)", status);
    ...
    /* 10) Drain pending IRPs (simple non-CSQ list) */
    for (;;) {
        PLIST_ENTRY le2;
        PIRP        qIrp;
    ...
    /* 11) Free leftover request wrappers */
    KeAcquireSpinLock(&fdoExt->QueueLock, &oldIrql);
    ...
    /* 12) Reset runtime flags and transfer context */
    ...
    TraceEvents(TRACE_LEVEL_INFORMATION, TRACE_FLAG_INIT,
                "StopDevice complete (Ctrl%lu)", fdoExt->ControllerId);
 ...
 *
 * NOTE:
 *  - XP/2003 cannot restart a bus controller without a new
 *    IRP_MN_START_DEVICE from PnP.
 *  - Therefore this routine performs only a StopDevice and returns.
    ...
    )
{
    ...
    if (fdoExt == NULL) {
        TraceEvents(TRACE_LEVEL_ERROR, TRACE_FLAG_INIT,
                    "RestartDevice: fdoExt=NULL");
        return STATUS_INVALID_PARAMETER;
    }

    TraceEvents(TRACE_LEVEL_INFORMATION, TRACE_FLAG_INIT,
                "RestartDevice begin (Ctrl%lu)", fdoExt->ControllerId);
    ...
    if (!NT_SUCCESS(status)) {
        TraceEvents(TRACE_LEVEL_ERROR, TRACE_FLAG_INIT,
                    "RestartDevice: StopDevice failed (0x%08lx)", status);
        return status;
    }
     ...
     */
    TraceEvents(TRACE_LEVEL_INFORMATION, TRACE_FLAG_INIT,
                "RestartDevice complete (Ctrl%lu) - awaiting PnP START_DEVICE",
                fdoExt->ControllerId);
 ...
 *
 * NOTE:
 *  - This performs ONLY controller teardown and resource cleanup.
    ...
    )
{
    ...
    if (KeGetCurrentIrql() != PASSIVE_LEVEL) {
        TraceEvents(TRACE_LEVEL_ERROR, TRACE_FLAG_INIT,
                    "RemoveDevice: invalid IRQL=%lu (expected PASSIVE_LEVEL)",
                    (ULONG)KeGetCurrentIrql());
        return STATUS_INVALID_DEVICE_STATE;
    }
    PAGED_CODE();
    ...
    if (fdoExt == NULL) {
        TraceEvents(TRACE_LEVEL_ERROR, TRACE_FLAG_INIT,
                    "RemoveDevice: fdoExt=NULL");
        return STATUS_INVALID_PARAMETER;
    }

    TraceEvents(TRACE_LEVEL_INFORMATION, TRACE_FLAG_INIT,
                "RemoveDevice begin (Ctrl%lu)", fdoExt->ControllerId);
     ...
     *   - drains queues
     *   - cancels pending IRPs
     *   - resets transfer context
     */
    status = I2cCtrl_StopDevice(fdoExt);
    if (!NT_SUCCESS(status)) {
        TraceEvents(TRACE_LEVEL_WARNING, TRACE_FLAG_INIT,
                    "RemoveDevice: StopDevice failed (0x%08lx)", status);
    ...
    TraceEvents(TRACE_LEVEL_INFORMATION, TRACE_FLAG_INIT,
                "RemoveDevice complete (Ctrl%lu)", fdoExt->ControllerId);
    ...
    )
{
    ...
    /* Reset workaround quirk */
    if ((g_CurrentRegMap.Quirks & QUIRK_NEEDS_RESET_WORKAROUND) != 0U) {
        KdPrint(("I2CCTRL: Applying reset workaround\n"));
        ctrl = I2cCtrl_ReadRegisterSafe(devctx, g_CurrentRegMap.ControlReg);
        if ((ctrl & CTRL_RESET_BIT) == 0U) {
            I2cCtrl_WriteRegisterSafe(devctx, g_CurrentRegMap.ControlReg, ctrl | CTRL_RESET_BIT);
        }
        ...
        if (tries >= 500U) {
            KdPrint(("I2CCTRL: Reset workaround timeout\n"));
        } else {
            KdPrint(("I2CCTRL: Reset workaround complete (tries=%lu)\n", tries));
        }
    }

    /* Broken clock gate quirk */
    if ((g_CurrentRegMap.Quirks & QUIRK_BROKEN_CLOCK_GATE) != 0U) {
        KdPrint(("I2CCTRL: Forcing clock enable due to quirk\n"));
        clk = I2cCtrl_ReadRegisterSafe(devctx, g_CurrentRegMap.ClockReg);
        clk |= CLK_ENABLE_BIT;
        clk &= ~CLK_GATE_BIT;
        I2cCtrl_WriteRegisterSafe(devctx, g_CurrentRegMap.ClockReg, clk);
        verify = I2cCtrl_ReadRegisterSafe(devctx, g_CurrentRegMap.ClockReg);
        if (((verify & CLK_ENABLE_BIT) == 0U) || ((verify & CLK_GATE_BIT) != 0U)) {
            KdPrint(("I2CCTRL: Clock enable verify failed\n"));
        } else {
            KdPrint(("I2CCTRL: Clock enable verify OK (0x%08lx)\n", verify));
        }
    }

    /* No DMA support quirk */
    if ((g_CurrentRegMap.Quirks & QUIRK_NO_DMA_SUPPORT) != 0U) {
        KdPrint(("I2CCTRL: Skipping DMA init (quirk)\n"));
        ctrl = I2cCtrl_ReadRegisterSafe(devctx, g_CurrentRegMap.ControlReg);
        if ((ctrl & CTRL_DMA_EN_BIT) != 0U) {
            I2cCtrl_WriteRegisterSafe(devctx, g_CurrentRegMap.ControlReg, ctrl & ~CTRL_DMA_EN_BIT);
        }
        KeStallExecutionProcessor(10U);
        verify = I2cCtrl_ReadRegisterSafe(devctx, g_CurrentRegMap.ControlReg);
        if ((verify & CTRL_DMA_EN_BIT) != 0U) {
            KdPrint(("I2CCTRL: DMA disable verify failed\n"));
        } else {
            KdPrint(("I2CCTRL: DMA disabled; PIO path active (CTRL=0x%08lx)\n", verify));
        }
    }

    /* ACPI 2.0+ quirk */
    if ((g_CurrentRegMap.Quirks & QUIRK_ACPI20) != 0U) {
        devctx->AcpiIs20Plus = TRUE;
        KdPrint(("I2CCTRL: ACPI 2.0+ quirk applied; wake from S1/S2/S3 supported\n"));
    }

    /* ACPI 1.0b quirk */
    if ((g_CurrentRegMap.Quirks & QUIRK_ACPI10) != 0U) {
        devctx->AcpiIs20Plus = FALSE;
        KdPrint(("I2CCTRL: ACPI 1.0b quirk applied; forcing S3-only wake fallback\n"));
    }

    /* Slow clock quirk */
    if ((g_CurrentRegMap.Quirks & QUIRK_SLOW_CLOCK) != 0U) {
        KdPrint(("I2CCTRL: Applying slow clock workaround (increase stall interval)\n"));
        devctx->StallIntervalUs += 5U; /* add extra delay margin */
    }

    /* No D1/D2 quirk */
    if ((g_CurrentRegMap.Quirks & QUIRK_NO_D1D2) != 0U) {
        KdPrint(("I2CCTRL: Disabling D1/D2 support due to quirk\n"));
        devctx->SupportsD1 = FALSE;
        devctx->SupportsD2 = FALSE;
    }

    /* ---------------- BSOD-tweak-workarounds ---------------- */

    if ((g_CurrentRegMap.BsodQuirks & BSOD_FORCE_PIO) != 0U) {
        KdPrint(("I2CCTRL: BSOD workaround: forcing PIO mode\n"));
        devctx->ForcePioMode = TRUE;
    }

    if ((g_CurrentRegMap.BsodQuirks & BSOD_MASK_INTERRUPTS) != 0U) {
        KdPrint(("I2CCTRL: BSOD workaround: masking interrupts aggressively\n"));
        I2cCtrl_MaskInterrupts(devctx, TRUE);
    }

    if ((g_CurrentRegMap.BsodQuirks & BSOD_EXTRA_RESET) != 0U) {
        KdPrint(("I2CCTRL: BSOD workaround: performing extra reset sequence\n"));
        I2cCtrl_PerformReset(devctx);
    }

    if ((g_CurrentRegMap.BsodQuirks & BSOD_DELAY_INIT) != 0U) {
        KdPrint(("I2CCTRL: BSOD workaround: delaying init by 50ms\n"));
